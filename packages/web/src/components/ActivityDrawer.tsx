    ...
    <>
      ...
      <aside
        ...
        style={{
          width: 420,
          boxShadow:
            "-1px 0 0 var(--gray-a5), -10px 0 30px rgba(0,0,0,0.08)",
        }}
      >
        <div
        ...
        >
          <div>
            <div className="text-[16px] font-semibold text-[var(--fg-1)]">
              Activity
            </div>
            <div className="mt-[2px] text-[12.5px] text-[var(--fg-3)]">
              webhooks streaming from{" "}
              <code
                className="rounded-[3px] bg-[var(--gray-3)] px-[5px] py-px font-mono text-[11.5px] font-medium"
              >
        ...
        <div className="overflow-y-auto px-[10px] pt-2 pb-6 flex-1">
          {events.length === 0 ? (
            <div className="p-6 text-center text-sm text-[var(--fg-3)]">
              No activity yet.
            </div>
          ) : (
            <div>
              {events.map((ev: LiveEvent, idx) => (
                <div
                  ...
                  style={{
                    ...
                    borderTop:
                      idx === 0 ? "none" : "1px solid var(--gray-a3)",
                  }}
                >
                  <span
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="leading-[18px] text-[var(--fg-1)]">
                      {ev.summary}
                    </div>
                    <div
                      className="mt-[2px] font-mono text-[11.5px] font-medium"
