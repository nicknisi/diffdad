  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mb-6 mt-1.5 text-[15px] leading-[22px] text-[var(--fg-2)]" style={{ maxWidth: '42ch' }}>
        ...
        >
          <div className="mb-2 text-[11px] font-medium uppercase tracking-[0.06em] text-[var(--fg-3)]">
          ...
          >
            <span className="font-bold" style={{ color: 'var(--purple-10)' }}>
              $
            </span>
        ...
        <div className="mb-6 flex flex-col gap-2">
          {STEPS.map((step) => (
            <div key={step.num} className="flex items-center gap-3 text-[13.5px] text-[var(--fg-2)]">
              <span
        ...
        <div className="mt-3.5 text-center text-[12px] text-[var(--fg-3)]">{copy.tagline}</div>
      </div>
    </div>
  );
}
